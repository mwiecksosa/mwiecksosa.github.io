...
I am a fourth-year PhD Student in [Statistics](https://www.cmu.edu/dietrich/statistics-datascience/index.html) at [Carnegie Mellon University](https://www.cmu.edu). 
...
*Papers*
- Estimating dynamic models by matching random features (with Cosma Shalizi). Submitted to the Journal of the American Statistical Association. [Preprint](https://mwiecksosa.github.io/estimation_random_features.pdf). [Slides](https://mwiecksosa.github.io/random_features_slides.pdf). [Code](https://github.com/mwiecksosa/random_features). 
- Dynamic models with p parameters are identified by 2p+1 random features (with Cosma Shalizi). Submitted to Physical Review E. [Preprint](https://arxiv.org/pdf/2607.16035). 
...
*Current projects*
- Probabilistic forecasting with deep generative dynamic models via the Wiener-Rosenblatt representation: Applications to transformers, RNNs, and DNNs  (with Cosma Shalizi).
- Deep conditional independence testing for multimodal time series with transformers: Applications to news and volatility (with Aaditya Ramdas). 
