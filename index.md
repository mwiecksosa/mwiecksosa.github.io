...
- Estimating dynamic models by matching random features (with Cosma Shalizi). Manuscript to be posted on arXiv upon acceptance, in accordance with the journal's policies. [Preprint](https://github.com/mwiecksosa/random_features/blob/main/estimation_random_features.pdf). [Code](https://github.com/mwiecksosa/random_features). 
