...
My primary research interest is nonstationary time series analysis. My work is largely motivated by the challenge of understanding nonlinear dynamics from a single realization of a high-dimensional stochastic process. I am especially interested in the implications for optimal nonlinear forecasting. I am inspired by many topics in statistics and machine learning, notably nonparametric regression estimation, high-dimensional statistics, deep neural networks, conditional independence testing, causal discovery, and observational causal inference.
