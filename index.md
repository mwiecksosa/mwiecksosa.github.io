...
- **Causality** (structural causal models, invariant causal prediction, causal representation learning, causal discovery, conditional independence testing)
...
*Works in Progress*
- Invariance-based causal representation learning for text-numeric time series using large language models (with Aaditya Ramdas). 
- Invariant causal prediction for nonlinear time series in nonstationary environments (with Aaditya Ramdas).
