...
*Current projects*
- Probabilistic forecasting with infinite memory using deep generative dynamic models via the Wiener-Rosenblatt-Wu representation (with Cosma Shalizi).
- Evaluating LLM agents under temporal distribution shifts with applications to prediction market forecasts (with Aaditya Ramdas). 
