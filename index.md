...
*Current projects*
- Probabilistic forecasting via deep generative dynamic models with theoretical guarantees: Applications to transformers, RNNs, and MLPs  (with Cosma Shalizi).
