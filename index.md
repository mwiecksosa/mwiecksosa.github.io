...
- **Dependent data** (high-dimensional time series, spatiotemporal data, time-varying networks, nonstationary, nonlinear, physical dependence)
...
*Under Revision*
- Conditional independence testing with a single realization of a multivariate nonstationary nonlinear time series (with Michel F. C. Haddad and Aaditya Ramdas). [arXiv](https://arxiv.org/pdf/2504.21647). [Slides](https://mwiecksosa.github.io/dGCM_slides.pdf).
...
- Dynamic variable importance for time series forecasting with foundation models: A case study of Chronos-2 and TabPFN-3 (with Tom Zhang and Chad Schafer).
...
- April 2026: I successfully proposed my thesis. The proposed work focuses on prediction with transformers.
