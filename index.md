...
*Works in Progress*
- Conditionally invariant representation learning for multimodal time series with transformers: Applications to financial text using LLMs (with Aaditya Ramdas). 
